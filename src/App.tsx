...
import { MdFilter, MdRestartAlt, MdOutlineDownloadForOffline } from 'react-icons/md';
    ...
    <main className='grid place-items-center h-screen px-2 md:px-4 lg:px-8'>
      <div className='lg:grid md:gap-4 gap-2 w-full 2xl:grid-cols-4 grid-cols-5 flex flex-col mt-2 md:mt-4 lg:mt-0 pb-2 md:pb-4 lg:pb-0'>
        <div className='2xl:col-auto col-span-2 p-8 bg-secondary text-gray-200 rounded-lg flex flex-col items-center space-y-2 lg:mt-0 lg:h-[690px]'>
          <a
            className='btn bg-red-600  hover:bg-blue-600/90 hover:shadow-lg'
            href='https://github.com/chalitha-pramod'
            target='_blank'
            rel='noreferrer noopener'
          >
            <p>git_chalitha_pramod</p>
            <BsStarFill />
          </a>
          ...
          <div className='space-x-3 flex w-full lg:flex-col lg:space-x-0 lg:space-y-3'>
            <button
              ...
              className={`${
                grayscale
                  ...
                  : 'bg-blue-600 hover:bg-blue-500/90'
              } btn hover:shadow-lg`}
            >
              <p>Grayscale</p>
              <MdFilter />
            ...
            <button onClick={downloadOptions} className='btn primary-bg'>
              <p>Download</p>
          ...
          <p className='text-sm pt-4'>
            © chalitha_pramod 2023 • All Rights Reserved
          </p>
        </div>
        ...
        >
          {file ? (
            ...
            <div className='text-gray-200 text-center'>
              <h2 className='text-3xl font-medium'>Text-Image Portrait Generator</h2>
